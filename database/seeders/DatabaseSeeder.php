...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $levels = [
            ...
            [
                'module_id' => '00000000-0000-0000-0000-000000000005',
                'level' => 'beginner',
        ...
        $vocabWords = [
            // Modul 1 Beginner
            ['id' => '00000000-0000-0000-0005-000000000101', 'module_id' => '00000000-0000-0000-0000-000000000001', 'level' => 'beginner', 'word' => 'collar', 'meaning' => 'kerah pakaian', 'example' => 'The shirt has a white collar around the neck.', 'emoji' => '👔', 'category' => 'Parts', 'order' => 1],
            ['id' => '00000000-0000-0000-0005-000000000102', 'module_id' => '00000000-0000-0000-0000-000000000001', 'level' => 'beginner', 'word' => 'sleeve', 'meaning' => 'lengan baju', 'example' => 'The long sleeve covers my arm completely.', 'emoji' => '🧥', 'category' => 'Parts', 'order' => 2],
            ['id' => '00000000-0000-0000-0005-000000000103', 'module_id' => '00000000-0000-0000-0000-000000000001', 'level' => 'beginner', 'word' => 'hemline', 'meaning' => 'keliman bawah', 'example' => 'She adjusted the hemline of the dress.', 'emoji' => '👗', 'category' => 'Parts', 'order' => 3],
            ['id' => '00000000-0000-0000-0005-000000000104', 'module_id' => '00000000-0000-0000-0000-000000000001', 'level' => 'beginner', 'word' => 'pocket', 'meaning' => 'saku, kantong', 'example' => 'I put my keys inside my front pocket.', 'emoji' => '👖', 'category' => 'Parts', 'order' => 4],
            ['id' => '00000000-0000-0000-0005-000000000105', 'module_id' => '00000000-0000-0000-0000-000000000001', 'level' => 'beginner', 'word' => 'seam', 'meaning' => 'garis jahitan', 'example' => 'The seam where the fabrics join is straight.', 'emoji' => '🧵', 'category' => 'Construction', 'order' => 5],

            // Modul 1 Intermediate
            ['id' => '00000000-0000-0000-0005-000000000106', 'module_id' => '00000000-0000-0000-0000-000000000001', 'level' => 'intermediate', 'word' => 'composition', 'meaning' => 'komposisi bahan', 'example' => 'Check the tag for the composition of the fabric.', 'emoji' => '🏷️', 'category' => 'Properties', 'order' => 1],
            ['id' => '00000000-0000-0000-0005-000000000107', 'module_id' => '00000000-0000-0000-0000-000000000001', 'level' => 'intermediate', 'word' => 'weave', 'meaning' => 'tenunan', 'example' => 'Twill weave creates diagonal lines on denim.', 'emoji' => '🕸️', 'category' => 'Structure', 'order' => 2],
            ['id' => '00000000-0000-0000-0005-000000000108', 'module_id' => '00000000-0000-0000-0000-000000000001', 'level' => 'intermediate', 'word' => 'drape', 'meaning' => 'jatuh kain', 'example' => 'Silk fabric has a beautiful drape when worn.', 'emoji' => '🧣', 'category' => 'Properties', 'order' => 3],
            ['id' => '00000000-0000-0000-0005-000000000109', 'module_id' => '00000000-0000-0000-0000-000000000001', 'level' => 'intermediate', 'word' => 'shrinkage', 'meaning' => 'penyusutan kain', 'example' => 'Hot water causes high shrinkage in wool clothes.', 'emoji' => '🔥', 'category' => 'Properties', 'order' => 4],
            ['id' => '00000000-0000-0000-0005-000000000110', 'module_id' => '00000000-0000-0000-0000-000000000001', 'level' => 'intermediate', 'word' => 'thread', 'meaning' => 'benang jahit', 'example' => 'The sewing thread is made of polyester.', 'emoji' => '🧵', 'category' => 'Materials', 'order' => 5],

            // Modul 2 Beginner
            ['id' => '00000000-0000-0000-0005-000000000201', 'module_id' => '00000000-0000-0000-0000-000000000002', 'level' => 'beginner', 'word' => 'natural', 'meaning' => 'alami', 'example' => 'Cotton is a natural fiber from plants.', 'emoji' => '🌱', 'category' => 'General', 'order' => 1],
            ['id' => '00000000-0000-0000-0005-000000000202', 'module_id' => '00000000-0000-0000-0000-000000000002', 'level' => 'beginner', 'word' => 'breathable', 'meaning' => 'tembus udara, adem', 'example' => 'Linen is a breathable fabric for hot weather.', 'emoji' => '💨', 'category' => 'Properties', 'order' => 2],
            ['id' => '00000000-0000-0000-0005-000000000203', 'module_id' => '00000000-0000-0000-0000-000000000002', 'level' => 'beginner', 'word' => 'durable', 'meaning' => 'awet, tahan lama', 'example' => 'Leather is a durable material for jackets.', 'emoji' => '🛡️', 'category' => 'Properties', 'order' => 3],
            ['id' => '00000000-0000-0000-0005-000000000204', 'module_id' => '00000000-0000-0000-0000-000000000002', 'level' => 'beginner', 'word' => 'cotton', 'meaning' => 'katun', 'example' => 'This cotton t-shirt is very soft.', 'emoji' => '👕', 'category' => 'Materials', 'order' => 4],
            ['id' => '00000000-0000-0000-0005-000000000205', 'module_id' => '00000000-0000-0000-0000-000000000002', 'level' => 'beginner', 'word' => 'fiber', 'meaning' => 'serat kain', 'example' => 'Wool is a warm animal fiber.', 'emoji' => '🐑', 'category' => 'Materials', 'order' => 5],

            // Modul 2 Intermediate
            ['id' => '00000000-0000-0000-0005-000000000206', 'module_id' => '00000000-0000-0000-0000-000000000002', 'level' => 'intermediate', 'word' => 'organic', 'meaning' => 'organik', 'example' => 'We use organic cotton grown without chemicals.', 'emoji' => '🌿', 'category' => 'Materials', 'order' => 1],
            ['id' => '00000000-0000-0000-0005-000000000207', 'module_id' => '00000000-0000-0000-0000-000000000002', 'level' => 'intermediate', 'word' => 'sustainable', 'meaning' => 'ramah lingkungan', 'example' => 'Eco-friendly fashion supports sustainable production.', 'emoji' => '🌍', 'category' => 'General', 'order' => 2],
            ['id' => '00000000-0000-0000-0005-000000000208', 'module_id' => '00000000-0000-0000-0000-000000000002', 'level' => 'intermediate', 'word' => 'textile', 'meaning' => 'tekstil', 'example' => 'The factory produces high-quality textile goods.', 'emoji' => '🏭', 'category' => 'Materials', 'order' => 3],
            ['id' => '00000000-0000-0000-0005-000000000209', 'module_id' => '00000000-0000-0000-0000-000000000002', 'level' => 'intermediate', 'word' => 'dye', 'meaning' => 'pewarna pakaian', 'example' => 'Natural dye is used to color the organic cloth.', 'emoji' => '🎨', 'category' => 'Chemicals', 'order' => 4],
            ['id' => '00000000-0000-0000-0005-000000000210', 'module_id' => '00000000-0000-0000-0000-000000000002', 'level' => 'intermediate', 'word' => 'biodegrade', 'meaning' => 'terurai secara alami', 'example' => 'Natural fibers biodegrade easily in soil.', 'emoji' => '🍂', 'category' => 'Properties', 'order' => 5],

            // Modul 3 Beginner
            ['id' => '00000000-0000-0000-0005-000000000301', 'module_id' => '00000000-0000-0000-0000-000000000003', 'level' => 'beginner', 'word' => 'temperature', 'meaning' => 'suhu cuci', 'example' => 'Wash the shirt at a low temperature of 30°C.', 'emoji' => '🌡️', 'category' => 'Care', 'order' => 1],
            ['id' => '00000000-0000-0000-0005-000000000302', 'module_id' => '00000000-0000-0000-0000-000000000003', 'level' => 'beginner', 'word' => 'bleach', 'meaning' => 'pemutih pakaian', 'example' => 'Do not use bleach on colored clothing.', 'emoji' => '🧪', 'category' => 'Care', 'order' => 2],
            ['id' => '00000000-0000-0000-0005-000000000303', 'module_id' => '00000000-0000-0000-0000-000000000003', 'level' => 'beginner', 'word' => 'iron', 'meaning' => 'setrika', 'example' => 'Use a hot iron to remove fabric wrinkles.', 'emoji' => '💨', 'category' => 'Care', 'order' => 3],
            ['id' => '00000000-0000-0000-0005-000000000304', 'module_id' => '00000000-0000-0000-0000-000000000003', 'level' => 'beginner', 'word' => 'wash', 'meaning' => 'mencuci', 'example' => 'You should wash dark colors separately.', 'emoji' => '🧼', 'category' => 'Care', 'order' => 4],
            ['id' => '00000000-0000-0000-0005-000000000305', 'module_id' => '00000000-0000-0000-0000-000000000003', 'level' => 'beginner', 'word' => 'dry', 'meaning' => 'mengeringkan', 'example' => 'Hang the wet dress outside to dry.', 'emoji' => '☀️', 'category' => 'Care', 'order' => 5],

            // Modul 3 Intermediate
            ['id' => '00000000-0000-0000-0005-000000000306', 'module_id' => '00000000-0000-0000-0000-000000000003', 'level' => 'intermediate', 'word' => 'solvent', 'meaning' => 'cairan pelarut kimia', 'example' => 'Dry cleaning uses a chemical solvent instead of water.', 'emoji' => '🧪', 'category' => 'Dry Cleaning', 'order' => 1],
            ['id' => '00000000-0000-0000-0005-000000000307', 'module_id' => '00000000-0000-0000-0000-000000000003', 'level' => 'intermediate', 'word' => 'delicate', 'meaning' => 'halus, rapuh', 'example' => 'Lace is a delicate fabric that tears easily.', 'emoji' => '🕸️', 'category' => 'Properties', 'order' => 2],
            ['id' => '00000000-0000-0000-0005-000000000308', 'module_id' => '00000000-0000-0000-0000-000000000003', 'level' => 'intermediate', 'word' => 'tumble', 'meaning' => 'putaran mesin pengering', 'example' => 'Do not tumble dry this woolen sweater.', 'emoji' => '🔄', 'category' => 'Care', 'order' => 3],
            ['id' => '00000000-0000-0000-0005-000000000309', 'module_id' => '00000000-0000-0000-0000-000000000003', 'level' => 'intermediate', 'word' => 'blend', 'meaning' => 'campuran serat', 'example' => 'This fabric is a cotton-polyester blend.', 'emoji' => '🌾', 'category' => 'Materials', 'order' => 4],
            ['id' => '00000000-0000-0000-0005-000000000310', 'module_id' => '00000000-0000-0000-0000-000000000003', 'level' => 'intermediate', 'word' => 'chemical', 'meaning' => 'bahan kimia', 'example' => 'Synthetic dyes contain strong chemical compounds.', 'emoji' => '⚗️', 'category' => 'General', 'order' => 5],

            // Modul 4 Beginner
            ['id' => '00000000-0000-0000-0005-000000000401', 'module_id' => '00000000-0000-0000-0000-000000000004', 'level' => 'beginner', 'word' => 'denim', 'meaning' => 'denim, jeans', 'example' => 'Blue jeans are made of denim fabric.', 'emoji' => '👖', 'category' => 'Materials', 'order' => 1],
            ['id' => '00000000-0000-0000-0005-000000000402', 'module_id' => '00000000-0000-0000-0000-000000000004', 'level' => 'beginner', 'word' => 'pockets', 'meaning' => 'kantong-kantong', 'example' => 'This jacket has four pockets on the front.', 'emoji' => '🧥', 'category' => 'Parts', 'order' => 2],
            ['id' => '00000000-0000-0000-0005-000000000403', 'module_id' => '00000000-0000-0000-0000-000000000004', 'level' => 'beginner', 'word' => 'fit', 'meaning' => 'kesesuaian pakaian', 'example' => 'The shirt has a slim fit style.', 'emoji' => '👕', 'category' => 'Style', 'order' => 3],
            ['id' => '00000000-0000-0000-0005-000000000404', 'module_id' => '00000000-0000-0000-0000-000000000004', 'level' => 'beginner', 'word' => 'chest', 'meaning' => 'lingkar dada', 'example' => 'Measure your chest circumference before ordering.', 'emoji' => '📏', 'category' => 'Sizing', 'order' => 4],
            ['id' => '00000000-0000-0000-0005-000000000405', 'module_id' => '00000000-0000-0000-0000-000000000004', 'level' => 'beginner', 'word' => 'size', 'meaning' => 'ukuran', 'example' => 'What size of pants do you wear?', 'emoji' => '🏷️', 'category' => 'Sizing', 'order' => 5],

            // Modul 4 Intermediate
            ['id' => '00000000-0000-0000-0005-000000000406', 'module_id' => '00000000-0000-0000-0000-000000000004', 'level' => 'intermediate', 'word' => 'moisture-wicking', 'meaning' => 'menyerap keringat', 'example' => 'Athletic wear uses moisture-wicking technology.', 'emoji' => '💦', 'category' => 'Properties', 'order' => 1],
            ['id' => '00000000-0000-0000-0005-000000000407', 'module_id' => '00000000-0000-0000-0000-000000000004', 'level' => 'intermediate', 'word' => 'spandex', 'meaning' => 'spandeks, serat elastis', 'example' => 'Sportswear has spandex for high flexibility.', 'emoji' => '🏃', 'category' => 'Materials', 'order' => 2],
            ['id' => '00000000-0000-0000-0005-000000000408', 'module_id' => '00000000-0000-0000-0000-000000000004', 'level' => 'intermediate', 'word' => 'elastic', 'meaning' => 'elastis', 'example' => 'The waistband has an elastic band inside.', 'emoji' => '🎗️', 'category' => 'Materials', 'order' => 3],
            ['id' => '00000000-0000-0000-0005-000000000409', 'module_id' => '00000000-0000-0000-0000-000000000004', 'level' => 'intermediate', 'word' => 'stretch', 'meaning' => 'meregang', 'example' => 'This fabric can stretch in four directions.', 'emoji' => '↔️', 'category' => 'Properties', 'order' => 4],
            ['id' => '00000000-0000-0000-0005-000000000410', 'module_id' => '00000000-0000-0000-0000-000000000004', 'level' => 'intermediate', 'word' => 'synthetic', 'meaning' => 'sintetis, buatan', 'example' => 'Nylon is a synthetic polymer material.', 'emoji' => '🧬', 'category' => 'Materials', 'order' => 5],

            // Modul 5 Beginner
            ['id' => '00000000-0000-0000-0005-000000000501', 'module_id' => '00000000-0000-0000-0000-000000000005', 'level' => 'beginner', 'word' => 'machine', 'meaning' => 'mesin jahit', 'example' => 'Turn on the sewing machine before starting.', 'emoji' => '🔌', 'category' => 'Tools', 'order' => 1],
            ['id' => '00000000-0000-0000-0005-000000000502', 'module_id' => '00000000-0000-0000-0000-000000000005', 'level' => 'beginner', 'word' => 'needle', 'meaning' => 'jarum jahit', 'example' => 'Insert the thread through the needle eye.', 'emoji' => '📍', 'category' => 'Tools', 'order' => 2],
            ['id' => '00000000-0000-0000-0005-000000000503', 'module_id' => '00000000-0000-0000-0000-000000000005', 'level' => 'beginner', 'word' => 'thread', 'meaning' => 'benang jahit', 'example' => 'The sewing thread is wound on a bobbin.', 'emoji' => '🧵', 'category' => 'Materials', 'order' => 3],
            ['id' => '00000000-0000-0000-0005-000000000504', 'module_id' => '00000000-0000-0000-0000-000000000005', 'level' => 'beginner', 'word' => 'straight', 'meaning' => 'lurus', 'example' => 'Sew a straight line along the edge.', 'emoji' => '📏', 'category' => 'Technique', 'order' => 4],
            ['id' => '00000000-0000-0000-0005-000000000505', 'module_id' => '00000000-0000-0000-0000-000000000005', 'level' => 'beginner', 'word' => 'stitch', 'meaning' => 'tusuk jahitan', 'example' => 'Make a tight stitch to join the fabrics.', 'emoji' => '🧵', 'category' => 'Technique', 'order' => 5],

            // Modul 5 Intermediate
            ['id' => '00000000-0000-0000-0005-000000000506', 'module_id' => '00000000-0000-0000-0000-000000000005', 'level' => 'intermediate', 'word' => 'zipper', 'meaning' => 'risleting', 'example' => 'The dress has a hidden zipper at the back.', 'emoji' => '🤐', 'category' => 'Parts', 'order' => 1],
            ['id' => '00000000-0000-0000-0005-000000000507', 'module_id' => '00000000-0000-0000-0000-000000000005', 'level' => 'intermediate', 'word' => 'seam-allowance', 'meaning' => 'kampuh jahitan', 'example' => 'Leave a 1.5 cm seam-allowance when cutting.', 'emoji' => '📏', 'category' => 'Technique', 'order' => 2],
            ['id' => '00000000-0000-0000-0005-000000000508', 'module_id' => '00000000-0000-0000-0000-000000000005', 'level' => 'intermediate', 'word' => 'hem', 'meaning' => 'kelim bawah', 'example' => 'Fold the hem twice and sew it.', 'emoji' => '👗', 'category' => 'Technique', 'order' => 3],
            ['id' => '00000000-0000-0000-0005-000000000509', 'module_id' => '00000000-0000-0000-0000-000000000005', 'level' => 'intermediate', 'word' => 'bias', 'meaning' => 'potongan serong', 'example' => 'Cutting on the bias makes the fabric stretchier.', 'emoji' => '✂️', 'category' => 'Technique', 'order' => 4],
            ['id' => '00000000-0000-0000-0005-000000000510', 'module_id' => '00000000-0000-0000-0000-000000000005', 'level' => 'intermediate', 'word' => 'alignment', 'meaning' => 'keselarasan jahitan', 'example' => 'Ensure proper alignment of the collar before sewing.', 'emoji' => '📐', 'category' => 'Technique', 'order' => 5],
        ];
        ...
        $quizzes = [
            // Placement
            ['id' => '00000000-0000-0000-0001-000000000001', 'module_id' => null, 'level' => 'placement', 'title' => 'Placement Quiz — Tes Kemampuan Awal', 'activity_type' => 'placement'],

            // Modul 1
            ['id' => '00000000-0000-0000-0001-000000000101', 'module_id' => '00000000-0000-0000-0000-000000000001', 'level' => 'beginner', 'title' => 'Kuis Modul 1: Bagian Pakaian Dasar', 'activity_type' => 'quiz'],
            ['id' => '00000000-0000-0000-0001-000000000102', 'module_id' => '00000000-0000-0000-0000-000000000001', 'level' => 'intermediate', 'title' => 'Kuis Modul 1: Sifat & Tenunan Kain', 'activity_type' => 'quiz'],

            // Modul 2
            ['id' => '00000000-0000-0000-0001-000000000201', 'module_id' => '00000000-0000-0000-0000-000000000002', 'level' => 'beginner', 'title' => 'Kuis Modul 2: Serat Alami & Kain', 'activity_type' => 'quiz'],
            ['id' => '00000000-0000-0000-0001-000000000202', 'module_id' => '00000000-0000-0000-0000-000000000002', 'level' => 'intermediate', 'title' => 'Kuis Modul 2: Eco-Fashion & Tekstil', 'activity_type' => 'quiz'],

            // Modul 3
            ['id' => '00000000-0000-0000-0001-000000000301', 'module_id' => '00000000-0000-0000-0000-000000000003', 'level' => 'beginner', 'title' => 'Kuis Modul 3: Instruksi Label Cuci', 'activity_type' => 'quiz'],
            ['id' => '00000000-0000-0000-0001-000000000302', 'module_id' => '00000000-0000-0000-0000-000000000003', 'level' => 'intermediate', 'title' => 'Kuis Modul 3: Perawatan Khusus Wool & Sutra', 'activity_type' => 'quiz'],

            // Modul 4
            ['id' => '00000000-0000-0000-0001-000000000401', 'module_id' => '00000000-0000-0000-0000-000000000004', 'level' => 'beginner', 'title' => 'Kuis Modul 4: Membaca Detail Katalog', 'activity_type' => 'quiz'],
            ['id' => '00000000-0000-0000-0001-000000000402', 'module_id' => '00000000-0000-0000-0000-000000000004', 'level' => 'intermediate', 'title' => 'Kuis Modul 4: Spesifikasi Activewear Teknis', 'activity_type' => 'quiz'],

            // Modul 5
            ['id' => '00000000-0000-0000-0001-000000000501', 'module_id' => '00000000-0000-0000-0000-000000000005', 'level' => 'beginner', 'title' => 'Kuis Modul 5: Dasar Jahitan Mesin', 'activity_type' => 'quiz'],
            ['id' => '00000000-0000-0000-0001-000000000502', 'module_id' => '00000000-0000-0000-0000-000000000005', 'level' => 'intermediate', 'title' => 'Kuis Modul 5: Pemasangan Zipper Tersembunyi', 'activity_type' => 'quiz'],
        ];
        ...
        $qaPairs = [
            ...
            [
                'question' => [
                    ...
                    'quiz_id' => '00000000-0000-0000-0001-000000000001',
                    'type' => 'vocab',
            ...
            [
                'question' => [
                    ...
                    'quiz_id' => '00000000-0000-0000-0001-000000000101',
                    'type' => 'vocab',
            ...
            [
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000103',
                    'answer_index' => 0,
            ...
            [
                'question' => [
                    ...
                    'quiz_id' => '00000000-0000-0000-0001-000000000102',
                    'type' => 'vocab',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000104',
                    'answer_index' => 1,
            ...
            [
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000105',
                    'answer_index' => 1,
            ...
            [
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000106',
                    'answer_index' => 1,
            ...
            [
                'question' => [
                    ...
                    'quiz_id' => '00000000-0000-0000-0001-000000000201',
                    'type' => 'vocab',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000201',
                    'answer_index' => 2,
            ...
            [
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000202',
                    'answer_index' => 2,
            ...
            [
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000203',
                    'answer_index' => 1,
            ...
            [
                'question' => [
                    ...
                    'quiz_id' => '00000000-0000-0000-0001-000000000202',
                    'type' => 'vocab',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000204',
                    'answer_index' => 1,
            ...
            [
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000205',
                    'answer_index' => 1,
            ...
            [
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000206',
                    'answer_index' => 1,
            ...
            [
                'question' => [
                    ...
                    'quiz_id' => '00000000-0000-0000-0001-000000000301',
                    'type' => 'vocab',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000301',
                    'answer_index' => 1,
            ...
            [
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000302',
                    'answer_index' => 2,
            ...
            [
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000303',
                    'answer_index' => 1,
            ...
            [
                'question' => [
                    ...
                    'quiz_id' => '00000000-0000-0000-0001-000000000302',
                    'type' => 'vocab',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000304',
                    'answer_index' => 1,
            ...
            [
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000305',
                    'answer_index' => 3,
            ...
            [
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000306',
                    'answer_index' => 1,
            ...
            [
                'question' => [
                    'id' => '00000000-0000-0000-0002-000000000401',
                    'quiz_id' => '00000000-0000-0000-0001-000000000401',
                    'type' => 'vocab',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000401',
                    'answer_index' => 2,
            ...
            [
                'question' => [
                    'id' => '00000000-0000-0000-0002-000000000402',
                    'quiz_id' => '00000000-0000-0000-0001-000000000401',
                    'type' => 'vocab',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000402',
                    'answer_index' => 1,
            ...
            [
                'question' => [
                    'id' => '00000000-0000-0000-0002-000000000403',
                    'quiz_id' => '00000000-0000-0000-0001-000000000401',
                    'type' => 'true_false',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000403',
                    'answer_index' => 1,
            ...
            [
                'question' => [
                    'id' => '00000000-0000-0000-0002-000000000404',
                    'quiz_id' => '00000000-0000-0000-0001-000000000402',
                    'type' => 'vocab',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000404',
                    'answer_index' => 1,
            ...
            [
                'question' => [
                    'id' => '00000000-0000-0000-0002-000000000405',
                    'quiz_id' => '00000000-0000-0000-0001-000000000402',
                    'type' => 'vocab',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000405',
                    'answer_index' => 1,
            ...
            [
                'question' => [
                    'id' => '00000000-0000-0000-0002-000000000406',
                    'quiz_id' => '00000000-0000-0000-0001-000000000402',
                    'type' => 'true_false',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000406',
                    'answer_index' => 0,
            ...
            [
                'question' => [
                    'id' => '00000000-0000-0000-0002-000000000501',
                    'quiz_id' => '00000000-0000-0000-0001-000000000501',
                    'type' => 'vocab',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000501',
                    'answer_index' => 1,
            ...
            [
                'question' => [
                    'id' => '00000000-0000-0000-0002-000000000502',
                    'quiz_id' => '00000000-0000-0000-0001-000000000501',
                    'type' => 'vocab',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000502',
                    'answer_index' => 2,
            ...
            [
                'question' => [
                    'id' => '00000000-0000-0000-0002-000000000503',
                    'quiz_id' => '00000000-0000-0000-0001-000000000501',
                    'type' => 'true_false',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000503',
                    'answer_index' => 1,
            ...
            [
                'question' => [
                    'id' => '00000000-0000-0000-0002-000000000504',
                    'quiz_id' => '00000000-0000-0000-0001-000000000502',
                    'type' => 'vocab',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000504',
                    'answer_index' => 1,
            ...
            [
                'question' => [
                    'id' => '00000000-0000-0000-0002-000000000505',
                    'quiz_id' => '00000000-0000-0000-0001-000000000502',
                    'type' => 'vocab',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000505',
                    'answer_index' => 2,
            ...
            [
                'question' => [
                    'id' => '00000000-0000-0000-0002-000000000506',
                    'quiz_id' => '00000000-0000-0000-0001-000000000502',
                    'type' => 'true_false',
                ...
                'answer' => [
                    'id' => '00000000-0000-0000-0004-000000000506',
                    'answer_index' => 0,
        ...
        foreach ($qaPairs as $pair) {
            Question::create($pair['question']);
            $answerData = $pair['answer'];
            $answerData['question_id'] = $pair['question']['id'];
